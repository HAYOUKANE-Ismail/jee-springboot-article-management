<div class="container">
    <div class="card shadow-hover">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h2 class="mb-0">
                <i class="fa fa-clipboard-list mr-2 text-gradient-primary"></i>
                Article List
            </h2>
            <div>
                <a href="${pageContext.request.contextPath}/createArticle.do" class="btn btn-primary">
                    <i class="fa fa-plus-circle mr-1"></i> Add New Article
                </a>
                <a href="${pageContext.request.contextPath}/searchArticles.do" class="btn btn-outline-primary ml-2">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${articles}" var="article">
                        <tr>
                            ...
                            <td>
                  <span class="badge ${article.quantite > 20 ? 'badge-success' : article.quantite > 10 ? 'badge-warning' : 'badge-danger'}">
                          ${article.quantite}
                  </span>
                            </td>
                            <td>$${article.price}</td>
                            <td class="text-center">
                                <a href="${pageContext.request.contextPath}/updateArticle.do?id=${article.id}"
